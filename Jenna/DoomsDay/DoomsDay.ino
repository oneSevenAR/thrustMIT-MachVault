...
const int ROTOR_STEP_DELAY_US = 800; // Your new, stable rotor speed.
              ...
              //Serial.println("Rotor");
                ...
                if (accumulator >= FOLLOWER_STEP_DENOMINATOR) {
                    ...
                    if (current_follower_steps >= follower_max_steps) {
                        ...
                        // Update LCD to show direction change
                        lcd.clear();
                        lcd.setCursor(0, 0);
                        lcd.print("End reached!");
                        lcd.setCursor(0, 1);
                        lcd.print("Reversing...");
                        delay(1000);

                        program_state = 5;  // Go to jog/manual state
